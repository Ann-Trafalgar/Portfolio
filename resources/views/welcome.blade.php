...
<body class="bg-black text-gray-300 antialiased selection:bg-blue-500 selection:text-white pb-10">
    ...
    <div class="max-w-6xl mx-auto px-4 py-2 md:px-6 md:py-4 space-y-3">
        ...
        <header class="flex flex-col md:flex-row gap-6 items-center md:items-start">
            <div class="relative w-32 h-32 md:w-44 md:h-44 rounded-2xl overflow-hidden shrink-0 group cursor-pointer">
                <!-- Default professional photo (shows by default) -->
            ...
            <div class="flex-1 flex flex-col items-center md:items-start text-center md:text-left h-full justify-center py-1">
                ...
                <p class="text-lg font-medium text-white mb-6 max-w-xl leading-tight">
                    Aspiring Software Engineer | Student | Laravel Enthusiast. <br>
                ...
                <div class="flex flex-wrap gap-3 justify-center md:justify-start w-full">
                    <button class="bg-white text-black font-bold px-6 py-2.5 rounded-lg text-sm hover:bg-gray-200 transition">Schedule a Call</button>
                    <button class="bg-black border border-white/20 hover:border-white text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition flex items-center gap-2">Send Email</button>
                    <button class="bg-black border border-white/20 hover:border-white text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition flex items-center gap-2">Join Community</button>
                </div>
            </div>
        </header>
        ...
        <div class="flex flex-col lg:flex-row gap-3 items-start">
            ...
            <!-- LEFT COLUMN -->
            <div class="w-full lg:w-[60%] flex flex-col gap-3 lg:items-stretch">
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8">
                ...
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="group relative block bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden hover:border-white/30 transition">
                            ...
                            <div class="bg-black p-4">
                                ...
                                <button class="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs text-white hover:bg-white hover:text-black transition">
                                    View Case Study
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="group relative block bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden hover:border-white/30 transition">
                            <div class="h-32 bg-gradient-to-br from-gray-900 to-black relative overflow-hidden flex items-center justify-center">
                                <div class="text-center">
                                    <div class="text-4xl text-orange-500 mb-2">←→</div>
                                    <div class="text-2xl font-bold text-white">Decode the</div>
                                    <div class="text-xs text-blue-400">Tech World</div>
                                </div>
                            </div>
                            <div class="bg-black p-4">
                                <h3 class="text-white font-bold text-sm mb-1">KodeCraze</h3>
                                <p class="text-gray-400 text-xs mb-3 line-clamp-2">Tech Trends & AI Platform - Founder/Content Strategy</p>
                                <button class="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs text-white hover:bg-white hover:text-black transition">
                                    kodecraze.com
                                </button>
                            </div>
                        ...
                        <div class="group relative block bg-[#0a0a0a] border border-white/10 rounded-xl overflow-hidden hover:border-white/30 transition">
                            <div class="h-32 bg-gradient-to-br from-pink-200 to-purple-200 relative overflow-hidden flex items-center justify-center">
                                <div class="text-center px-4">
                                    <div class="text-2xl font-bold text-gray-800 mb-1">Every story</div>
                                    <div class="text-xl font-bold text-green-700">starts with a</div>
                                    <div class="text-xl font-bold text-green-700">click.</div>
                                </div>
                            </div>
                            <div class="bg-black p-4">
                                <h3 class="text-white font-bold text-sm mb-1">OneClique Studio</h3>
                                <p class="text-gray-400 text-xs mb-3 line-clamp-2">Multimedia Team - UI/UX WordPress & SEO Optimization</p>
                                <button class="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg text-xs text-white hover:bg-white hover:text-black transition">
                                    onecliquestudio.com
                                </button>
                            </div>
                ...
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8 overflow-hidden group">
                    <h2 class="text-lg md:text-xl font-bold text-white mb-4 flex items-center gap-3">
                    ...
                    <p class="text-gray-400 text-sm mb-6 leading-relaxed">
                        When I step away from the tech world, I focus on the gym, games, and badminton to fuel my creativity and well-being.
                    </p>

                    <div class="relative w-full overflow-hidden h-32">
                        <div class="flex gap-4 absolute whitespace-nowrap animate-marquee">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Gym" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Travel" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Gaming" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Gym" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Travel" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                            <img src="https://placehold.co/200x120/1a1a1a/FFF?text=Gaming" class="h-32 w-48 object-cover rounded-xl border border-white/10">
                        </div>
                ...
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div class="space-y-4">
                        <div class="bg-[#0a0a0a] border border-white/5 p-5 rounded-xl flex flex-col md:flex-row gap-4 relative">
                            <svg class="w-8 h-8 text-white/5 absolute top-4 right-4" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
                            
                            <img src="https://ui-avatars.com/api/?name=Sarah+L&background=222&color=fff" class="w-12 h-12 rounded-full object-cover shrink-0 border border-white/10">
                            <div>
                                <h4 class="text-white font-bold text-sm">Beru</h4>
                                <p class="text-gray-500 text-xs mb-3">Lead Developer at TechSolutions Inc.</p>
                                <p class="text-gray-400 text-sm italic leading-relaxed">"Master Mark 
                                    is so good"</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-full lg:w-[40%] flex flex-col gap-3">
                ...
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-white font-bold mb-3">Programming Languages</h3>
                            <div class="flex flex-wrap gap-2">
                                <span class="px-3 py-1.5 bg-red-950/30 border border-red-500/50 rounded-lg text-sm text-red-300">Java</span>
                                <span class="px-3 py-1.5 bg-blue-950/30 border border-blue-500/50 rounded-lg text-sm text-blue-300">C++</span>
                            </div>
                        </div>
                        <div>
                ...
                <section class="bg-black border-2 border-white/10 rounded-2xl p-6 md:p-8">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <span class="text-xs font-bold text-green-400 border border-green-900/50 bg-green-900/20 px-2 py-1 rounded">GET IN TOUCH</span>
                    </div>
                    
                    <p class="text-gray-400 text-sm mb-6 leading-relaxed">
                        Available for Freelance and Collaboration. I'm open to discussing new projects, creative ideas or opportunities to be part of your visions.
                    </p>

                    <div class="space-y-3">
                        <a href="mailto:markjoshua@gmail.com" class="flex items-center gap-4 p-4 border border-white/10 rounded-xl hover:bg-white/5 transition group">
                            <div class="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center group-hover:bg-white/10 transition">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Email</p>
                                <p class="text-white text-sm">markjoshua@gmail.com</p>
                            </div>
                        </a>

                        <button class="w-full flex items-center gap-4 p-4 border border-white/10 rounded-xl hover:bg-white/5 transition group text-left">
                            <div class="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center group-hover:bg-white/10 transition">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Let's Talk</p>
                        ...
                        <button class="w-full flex items-center gap-4 p-4 border border-white/10 rounded-xl hover:bg-white/5 transition group text-left">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 font-bold uppercase tracking-wider">Community</p>
                                <p class="text-white text-sm">Join Discussion</p>
                            </div>
                        </button>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex gap-2">
                            <a href="#" class="w-10 h-10 border border-white/10 rounded-lg flex items-center justify-center text-gray-400 hover:text-white hover:border-white transition">
